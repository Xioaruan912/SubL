...
@media (max-width:520px) { .dashboard-page { padding:24px 14px 44px; }.hero-copy h1 { font-size:clamp(32px,11vw,40px); }.survival-panel { padding:20px; }.kpi-grid { grid-template-columns:1fr 1fr; gap:10px; }.kpi-grid article { min-height:126px; padding:16px; }.dashboard-section { margin-top:48px; }.section-heading-row{align-items:flex-start;flex-direction:column;gap:8px}.event-strip{padding:12px}.event-item{grid-template-columns:8px 72px minmax(0,1fr)} }
